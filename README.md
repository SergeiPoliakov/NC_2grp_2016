...
- UPD: Вроде поправил поиск и там еще немного нагородил в логике поиска по имени, пока вводим первое имена, каждое имя предварительно достраивается до одного или нескольких имеющихся в базе вариантов, а потом они уже проверяются на принадлежность одному юзеру (вA DD логике) или собираются все в кучу (OR).
