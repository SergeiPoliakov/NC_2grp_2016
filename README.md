...
### Анатолий 
#### (2017-04-11)
Сделал отправку уведомлений пользователям при подключении ко встрече, а также пару заготовок для приема соглашения на встречу и отказа (там либо создается дубликат встречи в виде отображения на расписание, либо нет). При согласии на встречу участникам встречи также отсылаются уцведомления, что такой-то пользователь присоединился ко встрече. Пришлось добавить несколько полей в базу для события и сделать ссылки на дубликаты для встречи. Пока много пробелов, скоро их закрою.