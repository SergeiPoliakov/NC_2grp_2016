...
### Виталий
Начал делать добавление новых тегов при создании встречи + поиск встреч по добавленным тегам с их отображением. В принципе уже работает, но нужно привести в должный вид. Исправил критическую ошибку с кэшом и встречами (обновление в кэше всегда происходило с id = 0). Попровил отображение на главной странице данных после регистрации
...
- UPD: Прикрутил возмоожность в в зависимости от настроек юзера выводить ту или иную статистику. Сначала грузятся настройки статистик, а потом уже самис статистики. Из бекенда можно задавать позицию, куда выводить, подписи осей графиков и пр. тя, я думаю, можно компактнее сделать на фронте все и более аккуратно. Подправьте тогда по возможности.