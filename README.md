...
### Анатолий 
#### (2017-04-11)
Сделал отправку уведомлений пользователям при подключении ко встрече, а также пару заготовок для приема соглашения на встречу и отказа (там либо создается дубликат встречи в виде отображения на расписание, либо нет). При согласии на встречу участникам встречи также отсылаются уцведомления, что такой-то пользователь присоединился ко встрече. Пришлось добавить несколько полей в базу для события и сделать ссылки на дубликаты для встречи. Пока много пробелов, скоро их закрою. Пока еще не все реализовано, я в процессе.
- UPD: Добавил новое поле к встречам и к событиям в liquibase, не забудьте обновить базу!

### Анатолий 
#### (2017-04-13)
Начал делать страницу оптимизации расписания юзера, поправил и добавил методы для работы со слот-сейвером, немного поправил DBHelp. Сейчас пользователю на страницу оптимизации подгружается расписание из сейвера. Чтобы подгрухить расписание, нужно выполнить запрос вида
