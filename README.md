...
- UPD: Переделал AJAX, теперь есть несколько служебных полей, чтобы можно было выбирать, по юзерам или по встречам искать теги, и логика OR или AND для посика тегов. Добавил парсер строки на слова-теги.