	...
	function addNotification(data){
		switch(data.type) {
			...
			case 'infoFriendAccept':  
				$("#notificationHolder").prepend('<li class="notification active"><div class="media"><div class="media-left"><div class="media-object"><img id="notificationImage" src="'+data.sender.picture+'" class="img-circle" alt="img"/></div></div><div class="media-body"><strong class="notification-title"><a href="/viewProfile/'+data.senderID+'">'+data.sender.name+ ' '+data.sender.surname+ '</a> принял вашу заявку в друзья</strong><div class="notification-meta"><small class="timestamp">'+data.date+'</small></div></div></div></li>');
				break;
			default:
				return;
		}
