/**
 * Created by Hroniko on 17.05.2017.
 */
...
function getStatSettings() {
    ...
    $.ajax({
        ...
        success: function (dataSetting) {
            ...
            var count_div = (dataSetting.length); // Необходимое количество одиночных карточек
            var count_loc = 1;
            ...
            for (var c = 0; c < count_div; c++){ // for (var c = 0; c < count_div; c++) // Создаем обычные карточки
                ...
                block_col_lg_12 += '</div>';
                count_loc ++;
                $("#insert_place_col-lg-12").append(block_col_lg_12); // в элемент с id="insert_place_col-lg-6"
            }
