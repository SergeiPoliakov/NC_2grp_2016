            ...
            <div class="card" style="width: 30rem;">
                ...
                <div class="btn-group btn-group-justified" id="acceptDeclineForm" role="group" aria-label="...">
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-success btn-block"><span class="glyphicon glyphicon-ok"
                                                                                      aria-hidden="true"> Принять</span>
                        </button>
                    </div>
                    <div class="btn-group" role="group">
                        <button type="button" class="btn btn-danger btn-block"><span class="glyphicon glyphicon-remove"
                                                                                     aria-hidden="true"> Отказаться</span>
                        </button>
                    </div>
                </div>
                <button type="button" class="btn btn-danger btn-block" id="leaveButton"><span
                        class="glyphicon glyphicon-remove" aria-hidden="true"> Покинуть встречу</span></button>
                <button type="button" class="btn btn-info btn-block" id="askToInviteButton" style="margin-top: 0px;">
                    <span class="glyphicon glyphicon-ok" aria-hidden="true"> Попроситься</span></button>
                ...
                <div class="form-inline" id="inviteAtMeetingForm">
                    ...
                    <option value="userID4">Василий Иванов</option>
                    <option value="userID5">Имя Фамилиев</option>
                    <option value="userID6">Аркадий Степанов</option>
                    <option value="userID7">Василий Иванов</option>
                    <option value="userID8">Имя Фамилиев</option>
                    <option value="userID9">Аркадий Степанов</option>
                    <option value="userID10">Василий Иванов</option>
                    <option value="userID11">Имя Фамилиев</option>
                    <option value="userID12">Аркадий Степанов</option>
                    <option value="userID13">Василий Иванов</option>
                    <option value="userID14">Имя Фамилиев</option>
                    <option value="userID15">Аркадий Степанов</option>
                    <option value="userID16">Василий Иванов</option>
                    <option value="userID17">Имя Фамилиев</option>
                    <option value="userID18">Аркадий Степанов</option>
                    <option value="userID19">Василий Иванов</option>
