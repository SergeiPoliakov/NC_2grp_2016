                    ...
                    <div class="panel-body">
                        <ul class="chat">
                            ...
                            <c:forEach items="${allUsers}" var="object">
                                ...
                                <a class="btn btn-success btn-xs" href="/addFriend/${object.id}/addFriend" <c:if test="${object.equals(currentUser)}"> disabled </c:if> onclick="sendMessage('friendRequest', ${object.id}, null, null)"><span class="glyphicon glyphicon-plus">   </span>В друзья</a>
