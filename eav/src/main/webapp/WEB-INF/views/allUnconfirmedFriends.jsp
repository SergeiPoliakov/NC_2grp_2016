...
<html lang="en">
<head>
    <title>Список друзей на подтверждение</title>
        ...
        <div class="col-md-5">
            <div class="panel panel-primary">
                <div class="panel-heading" id="accordion">
                    <span class="glyphicon glyphicon-list"></span> Заявки на добавление в друзья:
                </div>
                <div class="panel-collapse in" id="collapseOne">
                    <div class="panel-body">
                        <ul class="chat">

                            <c:forEach items="${allUnconfirmedFriends}" var="object">
                                ...
                                <a class="btn btn-success btn-xs" href="/addFriend/${object.id}/acceptFriend"><span class="glyphicon glyphicon-plus">   </span>В друзья</a>
                                </span>
