...
public class LoadingServiceImp implements LoadingService {
    ...
    @Override // 2017-03-25 С фильтром для нодов тегов
    public ArrayList<Integer> getListIdFilteredAlternative(TagFilter tagFilter) throws SQLException, NoSuchMethodException, IllegalAccessException, InvocationTargetException {
        return new DBHelp().getListObjectsByFilters(tagFilter);
    }
